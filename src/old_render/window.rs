...
use crate::old_render::common::{EffectShader, Shader, ShaderType, Texture, TextureRegion};
#[cfg(feature = "3d")]
...
#[cfg(feature = "3d")]
use crate::old_render::deferred::DeferredPass;
use crate::old_render::draw2d::DrawContext2D;
use crate::old_render::init::State;
#[cfg(feature = "3d")]
use crate::old_render::model::ModelLoader;
use crate::old_render::render2d::{EBuffer, EffectPass, RenderPass2D};
#[cfg(feature = "3d")]
use crate::old_render::render3d::{ForwardPass, RenderPass3D};
use crate::old_render::text::FontLoader;
use crate::old_render::{consts, ApplicationLoopCallbacks};
#[cfg(feature = "3d")]
use crate::old_render::common3d::{Mesh, Model};
#[cfg(feature = "3d")]
use crate::old_render::model::ModelFileType;
